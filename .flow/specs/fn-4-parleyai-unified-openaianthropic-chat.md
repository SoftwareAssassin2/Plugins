...
- **R9:** Docs updated: scaffolded `docs/config-management.md` (services/env rows + ParleyAI consumer), `_CLAUDE.md`, `README.md`, OTel note; skill `main.md`/`SKILL.md` + `marketplace.json` description; a repo-root `README.md` documenting `./src/` + the release procedure; and `LICENSE`/`NOTICE` (packed in the nupkg per R1).
