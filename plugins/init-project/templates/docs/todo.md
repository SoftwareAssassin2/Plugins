...
A running list of **engineering follow-ups** — deferred fixes, open questions, things to investigate, and tech debt noticed but not yet addressed. Captured here so loose ends survive between sessions instead of evaporating in chat history.
